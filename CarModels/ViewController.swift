...
class ViewController: UIViewController {
    ...
    private func update(rating: Double) {
        ...
        do {
            ...
            let alertController = UIAlertController(title: "Error", message: "Please, enter correct rating", preferredStyle: .alert)
    ...
    private func insertDataFrom(selectedCar car: Car) {
        ...
        myChoiceImageView.isHidden = !(car.myCoice)
    ...
    private func getDataFromFile() {
        ...
        for dictionary in dataArray {
            ...
            car.myCoice = carDictionary["myCoice"] as! Bool
